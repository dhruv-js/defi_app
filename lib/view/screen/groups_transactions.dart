...
class GroupsTransactionsScreen extends StatefulWidget {
  final Group group;
  const GroupsTransactionsScreen({super.key, required this.group});

  @override
  State<GroupsTransactionsScreen> createState() =>
      _GroupsTransactionsScreenState();
}

class _GroupsTransactionsScreenState extends State<GroupsTransactionsScreen> {
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: const [
                              ...
                              Text('This amount is paid by you, split equally',
                                  style: TextStyle(
...
void updateDebt(String groupTitle, String payer, double amt) {
  for (Group i in groups) {
    if (i.groupTitle == groupTitle) {
      ...
      int payerIndex = i.participants.indexWhere((element) => element == payer);
      for (int j = 0; j < i.debt.length; j++) {
        i.debt[j] += perPerson;
      }
